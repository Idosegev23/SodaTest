        ...
        <div className="prose prose-invert max-w-none">
          <div className="bg-[var(--color-gold-muted)] border border-[var(--color-gold-border)] rounded-lg p-6 md:p-10 space-y-8 font-rubik">
            ...
            <section>
              ...
              <div className="space-y-4 text-[var(--color-muted)] leading-relaxed">
                ...
                <div className="grid md:grid-cols-[200px_1fr] gap-3">
                  ...
                  <div>התחרות תתקיים בין התאריכים 20.10.2025-8/11/2025.</div>
                </div>
                <div className="grid md:grid-cols-[200px_1fr] gap-3">
                ...
                <div className="grid md:grid-cols-[200px_1fr] gap-3">
                  ...
                  <div>כרטיס טיסה זוגי לאירופה + כניסה למוזיאון עיצוב נבחר, והכל לפי בחירתה של סודהסטרים , לפי שיקול דעתה הבלעדי, ולמשתתף הזוכה ו/או למי מטעמו לא תהיה כל טענה ו/או דרישה ו/או תביעה כנגד בחירה זו.</div>
                </div>
                <div className="grid md:grid-cols-[200px_1fr] gap-3">
            ...
            <section>
              ...
              <div className="space-y-4 text-[var(--color-muted)] leading-relaxed">
                <p>5.1. בכפוף לכל דין, החברה על-פי שיקול דעתה הבלעדי, רשאית להאריך, לקצר או לשנות את תקופת התחרות, להוסיף זוכים, להוסיף פרסים או לשנותם, לשנות את מועד בחירת הזוכים וכן לבטל את התחרות ו/או לבצע כל פעולה אחרת בקשר עם הפעילות השיווקית של התחרות ובלבד שתודיע על השינויים כאמור בכל דרך סבירה.</p>
                <p>5.2. ההשתתפות בתחרות הינה באחריותו הבלעדית של המשתתף. בהשתתפותו בתחרות מסכים, מאשר ומצהיר המשתתף כי הוא קרא את התקנון והינו מקבל עליו את הוראותיו במלואן.</p>
                <p>5.3. למשתתפים ולכל מי מטעמם לא תהיה כל דרישה ו/או תביעה ו/או טענה מכל סוג ומין שהוא בקשר עם התחרות, הפרס, הפרס הגדול, התקנון ו/או לכל עניין אחר הכרוך בהם ובעצם השתתפותו פוטר המשתתף את החברה, עובדיה או מי מטעמה מכל טענה ו/או תביעה ו/או דרישה הקשורה במישרין או בעקיפין לתחרות ו/או לפרס. החברה וכל מי מטעמה, לא תהא אחראית לכל נזק ו/או הפסד ו/או הוצאה שייגרמו למי מהמשתתפים הקשורים במישרין ו/או בעקיפין בתחרות, ניהולה, תוצאותיה והפרס שיוענק במסגרתה.</p>
                <p>5.4. כל זכויות הקניין הרוחני בתחרות ובפרסומים הקשורים לתחרות, לרבות סימני מסחר, זכויות יוצרים, פטנטים ועיצובים, הינם רכושה הבלעדי של החברה.</p>
                <p>5.5. עותק מתקנון התחרות יימצא באתר האינטרנט של החברה.</p>
                <p>5.6. כל שאלה ועניין הקשורים לכתיבת, תוקף, פרשנות ואכיפת תקנון זה, או הקשורים לזכויות וחובות המשתתף והחברה בקשר עם התחרות, יהיו כפופים לחוקי מדינת ישראל. לבתי המשפט בעיר תל אביב-יפו תהיה סמכות השיפוט הבלעדית בכל עניין או מחלוקת הנוגעים לתקנון תחרות זה.</p>
                <p>5.7. למען הסר ספק, תקנון התחרות הינו לצורכי משחק בלבד והתחרות לא תחשב כהגרלה כהגדרתה בסעיף 224 בחוק העונשין וזאת בשל העובדה כי הזכייה אינה בדרך של גורל.</p>
              </div>
            </section>
