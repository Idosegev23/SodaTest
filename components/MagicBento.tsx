...
export interface BentoProps {
  artworks: BentoCardProps[];
  onArtworkClick: (artwork: BentoCardProps) => void;
...
const GlobalSpotlight: React.FC<{
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      gridRef.current?.querySelectorAll('.artwork-card').forEach(card => {
        (card as HTMLElement).style.setProperty('--glow-intensity', '0');
      });
                  ...
                  <div className="artwork-overlay">
                    <div className="artwork-info">
                      ...
                      <div className="artwork-likes">
                        <svg className="like-icon" fill="currentColor" viewBox="0 0 24 24">
