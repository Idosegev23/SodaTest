...
<body>
  <div class="container">
    ...
    <div class="section" style="margin-top: 30px;">
      <h2 class="section-title">📊 נתוני Vercel Analytics</h2>
      
      ${report.analytics && report.analytics.total_views !== 'N/A' ? `
      <div class="summary">
        <div class="stat-card">
          <div class="stat-value">${report.analytics.total_views || 0}</div>
          <div class="stat-label">צפיות באתר</div>
        </div>
        <div class="stat-card">
      ...
      ` : `
      <div style="background-color: #1a3a5c; border-radius: 12px; padding: 30px; text-align: center; border: 2px dashed #d4af37;">
        <p style="color: #d4af37; font-size: 18px; margin-bottom: 15px;">📊 לצפייה בנתוני Analytics המלאים</p>
        <p style="color: #8892ac; margin-bottom: 20px; line-height: 1.6;">
          כל הנתונים על כניסות, מבקרים, מקורות תנועה, מכשירים ומדינות זמינים בדשבורד של Vercel
        </p>
        <a href="https://vercel.com/idosegev23s-projects/soda-test/analytics" 
           style="display: inline-block; background-color: #d4af37; color: #0a1628; padding: 12px 30px; border-radius: 8px; text-decoration: none; font-weight: bold; margin-top: 10px;">
      ...
      <div style="background-color: #1a3a5c; border-radius: 12px; padding: 20px; margin-top: 20px;">
        <h3 style="color: #d4af37; font-size: 18px; margin-bottom: 15px;">מכשירים</h3>
        <div style="color: #8892ac;">
          ${Object.entries(report.analytics.devices).map(([device, count]) => `
            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
              <span>${device === 'desktop' ? '💻 Desktop' : device === 'mobile' ? '📱 Mobile' : device === 'tablet' ? '📱 Tablet' : device}</span>
              <span style="color: #d4af37; font-weight: bold;">${count}</span>
            </div>
          `).join('')}
        </div>
      </div>
      ...
      ${report.analytics.countries && report.analytics.countries.length > 0 ? `
      <div style="background-color: #1a3a5c; border-radius: 12px; padding: 20px; margin-top: 20px;">
        <h3 style="color: #d4af37; font-size: 18px; margin-bottom: 15px;">🌍 TOP מדינות</h3>
        <div style="color: #8892ac;">
          ${report.analytics.countries.map((country, idx) => `
            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
              <span>${idx + 1}. ${country.name || country.country || 'Unknown'}</span>
              <span style="color: #d4af37; font-weight: bold;">${country.count || country.views || 0}</span>
            </div>
          `).join('')}
        </div>
      </div>
      ...
      <div style="background-color: #1a3a5c; border-radius: 12px; padding: 20px; margin-top: 20px;">
        <h3 style="color: #d4af37; font-size: 18px; margin-bottom: 15px;">🔗 מקורות תנועה</h3>
        <div style="color: #8892ac;">
          ${report.analytics.referrers.map((ref, idx) => `
            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
              <span>${idx + 1}. ${ref.name || ref.referrer || 'Direct'}</span>
              <span style="color: #d4af37; font-weight: bold;">${ref.count || ref.visits || 0}</span>
            </div>
          `).join('')}
        </div>
      </div>
